...
public final class GithubVersionChecker
{
    ...
    public static GithubRelease getLatestRelease(URI projectUri)
    {
        String projectReleasesUrl = "https://api." + projectUri.getHost() + "/repos" + projectUri.getPath() + "/releases/latest";
        ...
        if (latestJsonData != null)
        {
            ...
            return parseJsonToRelease(projectUri.getPath().substring(projectUri.getPath().lastIndexOf("/") + 1), jsonObject);
        }

        return null;
    }

    public static GithubRelease getReleaseForTag(URI projectUri, String tag)
    {
        String currentTagUrl = "https://api." + projectUri.getHost() + "/repos" + projectUri.getPath() + "/releases/tags/" + tag;
        ...
        return parseJsonToRelease(projectUri.getPath().substring(projectUri.getPath().lastIndexOf("/") + 1), jsonElement.getAsJsonObject());
    }
